...
let myBatchWallet = {};
myBatchWallet.recoverWallet = {}

myBatchWallet.createWallet = () => {
...
myBatchWallet.recoverWallet.withSeedPhrase = (seedPhrase) => {
...
myBatchWallet.recoverWallet.withSecretKey = (privateKeyBase64) => {
    try {
