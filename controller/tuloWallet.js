...
tuloWallet.createWallet = async (userInfo) => {
...
tuloWallet.openWallet = async (res, userData) => {
...
tuloWallet.checkWalletExists = async (userInfo)=>{
    var returnData;
    if(!(userInfo.email)){
...
tuloWallet.authenticateWallet = async (req)  => {
    let returnData;
    if (!req.cookies.UID) {
